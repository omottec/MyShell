...
curl "http://wxpusher.zjiecode.com/api/send/message/?appToken=AT_cq86rvAxruXHE3Wln0rofaHChucGHS2s&content=pusher2test8online$count&uid=UID_SbrrStuX12A9Qh1at1fyzBn0MGpA&url=http%3a%2f%2fwxpusher.zjiecode.com"
if [ 1 -eq "$count" ] ; then
